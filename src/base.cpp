...
// #define PIN_ENABLE 8
// #include <hx711.h>
// //librairie de la carte de mesure en pont de wheatstone Hx711 attention librairie perso base sur première librairie
...
// void deplacement(long x,long y,long z) ;
...
//   x_facteur=float(X_COURROIE_PAS)*float(X_POULIE_Z)/float(X_MOTEUR_PAS); //facteur de conversion mm/pas   Espacement entre les dents de la courroie*nombre de dents de la poulie/
